import { FieldKind, FieldGroup, SectionHeaderSize } from '../enums';
...
const SIZE_CLASS: Record<SectionHeaderSize, string> = {
  [SectionHeaderSize.XS]: 'text-xs font-semibold',
  [SectionHeaderSize.SM]: 'text-sm font-semibold',
  [SectionHeaderSize.MD]: 'text-base font-semibold',
  [SectionHeaderSize.LG]: 'text-lg font-semibold',
  [SectionHeaderSize.XL]: 'text-xl font-semibold',
};
